...
\chapter{Test OM.jl}\label{test-om.jl}

Position Control with friction. Using Pole Placement + PD.

\hfill\break

\section{Response Analysis}\label{response-analysis-2}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# import Pkg; Pkg.add("OMJulia")}
\ImportTok{using} \BuiltInTok{OMJulia}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\ImportTok{using} \BuiltInTok{OMJulia.API}\NormalTok{: API}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{omc }\OperatorTok{=}\NormalTok{ OMJulia.}\FunctionTok{OMCSession}\NormalTok{();}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
[ Info: Path to zmq file="/tmp/openmodelica.icpmoles.port.julia.z0WV3KM0Lj"
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{modelfile }\OperatorTok{=} \FunctionTok{joinpath}\NormalTok{(}\PreprocessorTok{@\_\_DIR\_\_}\NormalTok{,}
  \StringTok{"modelica"}\NormalTok{,}
  \StringTok{"ControlChallenges"}\NormalTok{,}
  \StringTok{"package.mo"}\NormalTok{)}
\NormalTok{API.}\FunctionTok{loadFile}\NormalTok{(omc, modelfile)}

\NormalTok{classname }\OperatorTok{=} \StringTok{"ControlChallenges.BlockOnSlope\_Challenges.Examples.WithFriction"}
\FunctionTok{ModelicaSystem}\NormalTok{(omc,modelfile, classname)}

\NormalTok{fmuPath }\OperatorTok{=}\NormalTok{ API.}\FunctionTok{buildModelFMU}\NormalTok{(omc, classname)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
"/tmp/jl_Bdmswi/ControlChallenges.BlockOnSlope_Challenges.Examples.WithFriction.fmu"
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\ImportTok{using} \BuiltInTok{FMI}\NormalTok{, }\BuiltInTok{DifferentialEquations}\NormalTok{, }\BuiltInTok{Plots}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/content/block_on_slope/test_files/figure-pdf/cell-6-output-1.pdf}}
